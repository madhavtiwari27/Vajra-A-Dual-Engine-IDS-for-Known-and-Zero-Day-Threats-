...
class Ui_MainWindow(object):
    ...
    def train_model(self):
        try:
            ...
            if train_dataset and test_dataset:
                ...
                ga = tree.tree(train_dataset,test_dataset,population_size=5,mutation_rate=65)
                ga.initialization() 
                ...
                self.showdialog('Model train',f'Model trained successfully with fitness: {max_fitness}%',1)
        ...
        with open(dataset,"r") as file:
            for line in file.readlines():
                try:
                    ...
                    print("Err in static testing loop")
        self.threadActive = False
        ...
        try:
            for p in capture.sniff_continuously():
                try:
                    ...
                    if (time.time()-t1) > 60 and not self.isStop:
                        print("Updating List (60s timeout)")
                        self.packet.initiating_packets()
                        t1 = time.time()
                    ...
                    print(f"Error processing packet (internal): {e}")
        except Exception as e:
                print(f"Error in continuous sniffing loop: {e}")
    ...
    def setupUi(self, MainWindow):
        ...
        self.btn_realtimetesting.setText("Real Time Testing") 
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_realtimetesting.setText(_translate("MainWindow", "Real Time Testing")) 
        self.btn_realtimetesting.setStatusTip(_translate("MainWindow", "Real Time Testing"))
